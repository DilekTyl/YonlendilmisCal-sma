<%@ Page Language="C#" AutoEventWireup="true" CodeFile="kanbul.aspx.cs" Inherits="kanbul" %>
                ...
                <tr>
                    ...
                    <td colspan="7" rowspan="5">&nbsp;
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td colspan="4">&nbsp; 
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="kanbull" Enabled="False">
                                        <Columns>
                                    ...
                                    <asp:SqlDataSource ID="kanbull" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [adsoyad], [telefon], [email], [il], [ilce], [kangrubu] FROM [bagis]"></asp:SqlDataSource>
                                </td>
                            </tr>
                            </table>
                    </td>
